...
def export_SingBox(t_ips):
    ...
    data["outbounds"][22]["outbounds"].extend(["🚀TEHRAN-404", "🚀BERLIN-404", "🇳🇱H2-404", "🇲🇲ATOM(500MB)-404","🇯🇵JP-404","🇸🇬SG-404", "🇺🇸US-1-404", "🇺🇸US-2-404","🇰🇷KR-404", "🇭🇰HK-404", "🇯🇵JP-1-404", "🇯🇵JP-2-404", "🇸🇬SG-1-404", "🇸🇬SG-2-404", "🇸🇬SG-3-404", "🇸🇬SG-4-404", "🇬🇧UK-1-404", "🇬🇧UK-2-404", "🇭🇰HK-1-404", "🇭🇰HK-2-404", "🇭🇰HK-3-404", "🇭🇰HK-4-404", "404-VPN.Pro",])
