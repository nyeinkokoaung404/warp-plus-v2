...
def export_SingBox(t_ips):
    ...
    data["outbounds"][15]["outbounds"].extend(["🚀TEHRAN-404", "🚀BERLIN-404", "🇲🇲MM-404", "🇳🇱H2-404", "🇯🇵JP-404", "🇸🇬SG-404", "🇺🇸US-404", "🇹🇭TRUE-404", "🇭🇰HK-404", "🇯🇵JP-1-404", "🇯🇵JP-2-404", "🇸🇬SG-1-404", "🇸🇬SG-2-404", "🇬🇧UK-1-404", "🇬🇧UK-2-404", "🇭🇰HK-1-404", "🇭🇰HK-2-404"])
